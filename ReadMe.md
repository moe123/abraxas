...
<sub><sup>1 - </sup></sub><sub><sup>std\accumulate, std\adjacent_find, std\all_of, std\any_of, std\binary_search, std\clamp, std\copy, std\copy_backward, std\copy_if, std\copy_n, std\count, std\count_if, std\equal, std\equal_range, std\fill, std\fill_n, std\find, std\find_end, std\find_first_of, std\find_if, std\find_if_not, std\for_each, std\for_each_n, std\generate, std\generate_n, std\includes, std\inner_product, std\iota, std\is_permutation, std\iter_swap, std\lexicographical_compare, std\lower_bound, std\max, std\max_element, std\merge, std\min, std\min_element, std\minmax, std\minmax_element, std\mismatch, std\next_permutation, std\none_of, std\partial_sum, std\partition, std\partition_point, std\prev_permutation, std\remove, std\remove_if, std\replace, std\replace_if, std\reverse, std\rotate, std\rotate_copy, std\search, std\search_n, std\set_difference, std\set_intersection, std\set_symmetric_difference, std\set_union, std\shuffle, std\sort, std\stable_sort, std\swap, std\swap_ranges, std\transform, std\unique, std\unique_copy, std\upper_bound</sup></sub>
