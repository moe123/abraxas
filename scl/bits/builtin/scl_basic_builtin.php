...
namespace
{
	require_once __DIR__ . DIRECTORY_SEPARATOR . "scl_builtin_algorithm.php";
	require_once __DIR__ . DIRECTORY_SEPARATOR . "scl_builtin_container_traits.php";
	require_once __DIR__ . DIRECTORY_SEPARATOR . "scl_builtin_io.php";
