...
namespace
{
	require_once __DIR__ . DIRECTORY_SEPARATOR . "___scl_base_iterator_traits.php";
	require_once __DIR__ . DIRECTORY_SEPARATOR . "___scl_base_container_traits.php";
	require_once __DIR__ . DIRECTORY_SEPARATOR . "___scl_base_operator_traits.php";
	require_once __DIR__ . DIRECTORY_SEPARATOR . "___scl_base_utility_traits.php";
	require_once __DIR__ . DIRECTORY_SEPARATOR . "___scl_base_algorithm.php";
